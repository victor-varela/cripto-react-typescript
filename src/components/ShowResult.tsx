...
const ShowResult = () => {
  ...
  const isPositive = result.CURRENT_DAY_CHANGE_PERCENTAGE > 0;
          ...
          <>
            ...
            <div className="result">
              ...
              <div className="info">
                ...
                <p>
                  La variacion del dia es:{" "}
                  <span>
                    {result.CURRENT_DAY_CHANGE_PERCENTAGE.toLocaleString()}%
                    <FontAwesomeIcon
                      icon={isPositive ? faArrowUp : faArrowDown}
                      style={{ marginLeft: "0.5rem", color: isPositive ? "green" : "red" }}
                    />
                  </span>
                </p>
              </div>
